...
const SidebarLink = ({link, iconName}) => {
  ...
  return (
    <NavLink
    to={link.path}
    className={ `text-richblack-300 py-2 px-4 relative md:px-8 md:py-2 text-sm font-medium transition-all duration-300 ${matchRoute(link.path) ? "bg-yellow-800" :"bg-opacity-0"}`}
    >
